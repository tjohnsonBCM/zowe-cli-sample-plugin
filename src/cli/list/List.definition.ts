...
import { GitHubIssuesDefinition } from "./github-issues/GitHubIssues.definition";
/**
...
const ListDefinition: ICommandDefinition = {
    ...
    type: "group",
    children: [DirectoryContentsDefinition, TypicodeTodosDefinition, GitHubIssuesDefinition]
};
